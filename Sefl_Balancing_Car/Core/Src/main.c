...
/* USER CODE BEGIN 0 */
uint32_t speed = 0;
uint32_t distance = 0.0f;
SRF05_HandleTypeDef hSrf;

void AdjustSpeed(){
	distance = (uint32_t)SRF05_GetDistance(&hSrf);
	...
	if(distance >= 20 && distance <= 100){
		speed = 1000 + (distance * 20);
		if (speed > 3199) speed = 3199;            
...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
	...
	SRF05_Init(&hSrf, GPIOA, GPIO_PIN_6, GPIOA, GPIO_PIN_5, &htim2);
